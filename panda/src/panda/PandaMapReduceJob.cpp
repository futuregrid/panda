...
namespace panda
{
  ...
  void PandaMapReduceJob::PandaLaunchLocalMergeOutputOnGPU()
  {
	  PandaExecuteShuffleMergeOnGPU(this->pNodeContext, this->pGPUContext);
  }//void

  void PandaMapReduceJob::PandaLaunchSortResultsOnGPU()
  {
	   PandaExecuteSortOnGPU(this->pGPUContext);
  }//int

  void PandaMapReduceJob::PandaLaunchSortResultsOnCPU()
  {
	  PandaExecuteSortOnCPU(this->pCPUContext, this->pNodeContext);
  }//int

  void PandaMapReduceJob::PandaLaunchSortResultsOnGPUCard()
  {
 ...
 int PandaMapReduceJob::PandaLaunchReduceTasksOnGPU()
	{
	...
	int PandaMapReduceJob::PandaLaunchMapTasksOnCPU()
	{
...
int PandaMapReduceJob::PandaLaunchMapTasksOnGPUCard()
{
 ...
 int PandaMapReduceJob::PandaLaunchMapTasksOnGPUHost()
	{		
 ...
 void PandaMapReduceJob::PandaInitMapReduceOnCPU()
 {
...
void PandaMapReduceJob::PandaInitMapReduceOnGPUCard()
{
...
void PandaMapReduceJob::PandaInitMapReduceOnGPU()
{
	...
	void PandaMapReduceJob::PandaInitRuntime(){
  ...
  void PandaMapReduceJob::PandaLaunchExitMessager()
  {
  ...
  void PandaMapReduceJob::PandaLaunchCombinerOnCPU()
  {
	  PandaExecuteCombinerOnCPU(this->pCPUContext);
  }//void

  void PandaMapReduceJob::PandaLaunchCombinerOnGPUCard()
  {
	  PandaExecuteCombinerOnGPUCard(this->pGPUCardContext);
  }//void

  void PandaMapReduceJob::PandaLaunchCombinerOnGPU()
  {
	  PandaExecuteCombinerOnGPU(this->pGPUContext);
  }//void 
			
  void PandaMapReduceJob::PandaLaunchSortBucket()
  {
	  PandaExecuteSortBucketOnCPU(this->pNodeContext);
  }//for

  void PandaMapReduceJob::PandaLaunchCopyRecvedBucketToGPU(int start_task_id, int end_task_id)
  {
  ...
  void PandaMapReduceJob::PandaLaunchCopyRecvedBucketToGPUCard(int start_task_id, int end_task_id)
  {
  ...
  void PandaMapReduceJob::PandaLaunchCopyRecvedBucketToCPU(int start_task_id, int end_task_id)
  {
  ...
  void PandaMapReduceJob::PandaLaunchReduceTasksOnCPU(){
